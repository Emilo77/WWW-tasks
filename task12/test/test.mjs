...
describe("Test error page and form", function () {
    ...
    it("should successfully send form", async () => {
        ...
        await driver.findElement(By.id("first_name")).sendKeys("Es");
        await driver.findElement(By.id("last_name")).sendKeys("Essa");
        await driver.findElement(By.id("phone")).sendKeys("123456789");
        await driver.findElement(By.id("email")).sendKeys("esssa@gmail.com");
